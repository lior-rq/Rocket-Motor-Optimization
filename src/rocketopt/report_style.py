"""The stylesheet and font link shared by every generated report."""
...
#: Print rules. The screen stylesheet alone paginates badly: dark mode bleeds
#: onto the page and figures straddle sheet boundaries.
PRINT_CSS = """
@media print {
